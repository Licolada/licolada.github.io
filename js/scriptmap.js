...
let apMap = L.map('apMap').setView([51.20027, 4.39180], 22);
...
let bounds = [[51.20018066263775, 4.391496636279293], [51.20035654805728, 4.392302694725194]];
// kleur de rechthoek in met de rode AP-kleur
L.rectangle(bounds, {color: "#e60005", weight: 1}).addTo(apMap);
// plaats een marker met als tekst "AP-Hogeschool" en eronder "Ellermanstraat 33"
let apMarker = L.marker([51.20027, 4.39180]).addTo(apMap);
apMarker.bindPopup("<b>Installatie van Slimme inbraakalarm").openPopup();